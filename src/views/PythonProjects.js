...
const PythonProjects = () => {
    return (
        <>
            ...
            <div className={'content_container'}>
                <p id={'section_text'}>
                    The repository containing the source code for this project
                    can be found{' '}
                    <a
            ...
            {/*<div className={'content_container'}>*/}
            {/*    <p id={'page_title_text'}>Random Forest Classifier</p>*/}
            {/*</div>*/}
            ...
            <div className={'content_container'}>
                <p id={'section_text'}>
                    Checkout the live production app on
                    <a
                        href={ml_app_location}
                        target={'_blank'}
                        rel={'noreferrer'}
                    >
                        {' '}
                    ...
                    . You will need the default credentials of username "admin"
                    and password "admin" to log in and access all areas of the
                    application.
                </p>
            </div>
